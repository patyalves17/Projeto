...
//    }
    ...
    public LocalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View meuLayoutVisited = inflater.inflate(R.layout.visited_row, parent,false);
        return new LocalViewHolder(meuLayoutVisited);
    }
    ...
    //    holder.tvFoto.setImageBitmap(Bitmap.createBitmap(decodedByte));
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                builder.setTitle(R.string.dialogDeleteTitulo)
